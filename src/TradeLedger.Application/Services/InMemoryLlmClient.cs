    ...
    TimeProvider timeProvider) : ILlmClient
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var symbol = positions
            ...
            .FirstOrDefault(candidate => question.Contains(candidate, StringComparison.OrdinalIgnoreCase));
        ...
        var period = GetPeriod(question, timeProvider.GetUtcNow());
